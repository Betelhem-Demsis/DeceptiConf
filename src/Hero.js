...
import bg1 from "./images/background.6c3571e0.jpg"
export default function Hero() {
  return (
    <div>
       <section class="relative pb-20 pt-10 sm:py-24">
                    <div class="absolute inset-x-0 -bottom-14 -top-48 overflow-hidden bg-indigo-50">
                        <img alt="images" fetchpriority="high" width="918" height="1495" decoding="async" data-nimg="1" class="absolute left-0 top-0 translate-x-[-55%] translate-y-[-10%] -scale-x-100 sm:left-1/2 sm:translate-x-[-98%] sm:translate-y-[-6%] lg:translate-x-[-106%] xl:translate-x-[-122%]" style={{color: "transparent"}} src={bg1} />
